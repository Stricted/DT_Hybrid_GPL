...
#if defined(CONFIG_PCIE0_HISI_SD5115)
...
#if defined(CONFIG_PCIE1_HISI_SD5115)
#include "hipciev101/pcie_godbox_1.h"

/* For hisilicon pcie controller fixup */
static void __devinit quirk_hisi_isr1(struct pci_dev  *dev)
{
	unsigned char irq;
	struct pci_bus *bus;
...
DECLARE_PCI_FIXUP_HEADER(PCI_ANY_ID, PCI_ANY_ID, quirk_hisi_isr1);
#endif
#endif	//#ifdef CONFIG_HISI_SD5115
