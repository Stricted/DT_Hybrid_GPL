...
#if 0 /* <DTS2012081608784 g68080 2012-09-13 mod */
#include <asm/io.h>
extern int g_isDataCard;
extern int g_USB_PROBE;
#endif
...
free_interfaces:
	...
	if ((0x1A8D == dev->descriptor.idVendor) || (0x8D1A == dev->descriptor.idVendor) ||
		((0x12d1 == dev->descriptor.idVendor) || (0xd112 == dev->descriptor.idVendor)) && !atomic_read(&g_iDataCardIn))
	{
		printk("\n==find hw card===\n");
...
#if !defined(CONFIG_B880_PRODUCT)
#ifdef SUPPORT_ATP_WANUMTS
