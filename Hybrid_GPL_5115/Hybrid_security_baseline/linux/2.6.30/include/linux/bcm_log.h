...
typedef struct
{
    ...
    int (*kerSysSlaveWrite)( unsigned long addr, unsigned long data, unsigned long len);
    int (*kerSysSlaveRead)( unsigned long addr, unsigned long *data, unsigned long len);
