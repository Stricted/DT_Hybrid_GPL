...
<修改人>     	 	<时间>       	 <问题单号>          <简要描述>
z00185914    		2013/05/28    DTS2013052903708    	[驱动][B880]-V100R001C994B108(Router):更新海思驱动
========================================================================================*/
...
/*--- members common to fkbuff: end here ---*/
	...
	atomic_t			users;
#ifndef CONFIG_BRCM_412L02   /*w00182844 modify for BCM963268 wlan driver*/
	char				*extif;
#endif
...
struct sk_buff {
	 ...
	 */
	char			cb[48];
/* <DTS2013052903708 z00185914 2013/05/28 BEGIN */
#if defined(CONFIG_B880_PRODUCT)
    char          hi_cb[48]; 
#endif
/* DTS2013052903708  z00185914 2013/05/28 END> */
#if 1//defined(CONFIG_IMQ) || defined(CONFIG_IMQ_MODULE)
        /* add lan interface (eth0.5) in iptables 20090217 */
    struct net_device   *lanindev;
#endif
