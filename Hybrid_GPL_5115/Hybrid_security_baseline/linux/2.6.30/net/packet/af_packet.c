...
/* START ADD :w00182511 2011/11/15  FOR DTS2011110903921:support ipcheck for arp*/
#ifdef CONFIG_SUPPORT_ATP
#define LAN1_MARK  0x10000000
#define LAN2_MARK  0x20000000
#define LAN3_MARK  0x30000000
#define LAN4_MARK  0x40000000
#define WLAN1_MARK 0x50000000
#define WLAN2_MARK 0x60000000
#define WLAN3_MARK 0x70000000
#define WLAN4_MARK 0x80000000
static int mark_lan_index(unsigned long nfmark)
{
    int lRet = 0;
    switch(nfmark & 0xF0000000)
    {
        case LAN1_MARK:    //eth0.5
            lRet = 4;
            break;  
        case LAN2_MARK:    //eth0.4
            lRet = 3;
            break;  
        case LAN3_MARK:    //eth0.3
            lRet = 2;
            break; 
        case LAN4_MARK:    //eth0.2
            lRet = 1;
            break;  
        case WLAN1_MARK:   //wl0.0
            lRet = 5;
            break;  
        case WLAN2_MARK:   //wl0.1
            lRet = 6;
            break;  
        case WLAN3_MARK:   //wl0.2
            lRet = 7;
            break;  
        case WLAN4_MARK:   //wl0.3
            lRet = 8;
            break; 
        default:
            lRet = -1;
...
#endif
/* END ADD :w00182511 2011/11/15  FOR DTS2011110903921:support ipcheck for arp*/
...
static int packet_rcv_spkt(struct sk_buff *skb, struct net_device *dev,  struct packet_type *pt, struct net_device *orig_dev)
{
...
#ifdef CONFIG_SUPPORT_ATP
	{
	    ...
	    if (htons(ETH_P_ARP) == po->num)
	    {
	        spkt->spkt_protocol = mark_lan_index(skb->mark);
	    }
	}
#endif
    /* END ADD :w00182511 2011/11/15  FOR DTS2011110903921:support ipcheck for arp*/
