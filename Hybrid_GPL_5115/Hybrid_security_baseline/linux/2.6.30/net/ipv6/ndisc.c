...
static void ndisc_recv_ns(struct sk_buff *skb)
{
	...
	if (ifp) {
        ...
        /* <DTS2012071401081  w00211169 2012-7-14 begin */        
            ...
            extern struct inet6_ifaddr * ipv6_get_prefix_ifaddr(struct in6_addr *addr, 
                                                struct net_device *dev, int strict,
                                                int prefix_len);
		    #define IPV6_PREFIX_LEN_3GPP (64)
            if(!ipv6_get_prefix_ifaddr(&msg->target, dev, 1, IPV6_PREFIX_LEN_3GPP))
            {
                goto out;
            }
        }
