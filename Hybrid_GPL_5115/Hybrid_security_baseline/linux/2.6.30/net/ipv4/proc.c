...
/* <DTS2013072204135 z81004143 2013/8/6 begin */
#ifdef CONFIG_B880_PRODUCT
extern unsigned long rx_packets;

static int inputstat_seq_show(struct seq_file *seq, void *v)
{	
	seq_printf(seq, "RXIP:%d\n", rx_packets);
	return 0;
}

static int inputstat_seq_open(struct inode *inode, struct file *file)
{
	return single_open(file, inputstat_seq_show, NULL);
}

static const struct file_operations inputstat_seq_fops = {
	.owner	 = THIS_MODULE,
	.open	 = inputstat_seq_open,
	.read	 = seq_read,
	.llseek	 = seq_lseek,
	.release = single_release_net,
};
#endif
/* DTS2013072204135 z81004143 2013/8/6 end> */
...
/* <DTS2013072204135 z81004143 2013/8/6 begin */
#ifdef CONFIG_B880_PRODUCT
    (void)proc_net_fops_create(net, "rxipstat", S_IRUGO, &inputstat_seq_fops);
#endif
/* DTS2013072204135 z81004143 2013/8/6 end> */
