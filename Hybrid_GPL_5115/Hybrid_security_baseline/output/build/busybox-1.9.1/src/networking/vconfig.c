...
struct vlan_ioctl_args {
	...
	union {
        ...
        int nfmark_to_priority; //支持802.1p
	} u;
...
static const char cmds[] ALIGN1 = {
	...
	'i', 'n', 'g', 'r', 'e', 's', 's', '_',
	'm', 'a', 'p', 0,
/*start of y42304 added 2009-3-20: 增加对vconfig nfmark_to_priority的支持，给接口打802.1p*/
	4, SET_VLAN_NFMARK_TO_PRIORITY_CMD, 22,
	'n', 'f', 'm', 'a', 'r', 'k',
	'_', 't', 'o', '_', 'p', 'r', 'i', 'o', 'r', 'i', 't', 'y', 0,
/*end of y42304 added 2009-3-20: 增加对vconfig nfmark_to_priority的支持，给接口打802.1p*/
};
