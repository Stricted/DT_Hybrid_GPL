...
USE_ATP_ARP(APPLET(arp, _BB_DIR_SBIN, _BB_SUID_NEVER))
...
USE_ATP_FTP(APPLET(ftpget, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
/*Start of Maintain 2008-3-1 17:11 for 修改Busybox中的传输工具，满足cwmp传输需求 by z65940*/
USE_ATP_FTP(APPLET_ODDNAME(ftpput, ftpget, _BB_DIR_USR_BIN, _BB_SUID_NEVER, ftpget))
/*End of Maintain 2008-3-1 17:11 for 修改Busybox中的传输工具，满足cwmp传输需求 by z65940*/
...
USE_HTTPDIAG(APPLET(httpdiag,  _BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
USE_ATP_MCAST(APPLET(mcast, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
USE_ATP_PING(APPLET(ping, _BB_DIR_BIN, _BB_SUID_MAYBE))
USE_ATP_PING6(APPLET(ping6, _BB_DIR_BIN, _BB_SUID_NEVER))
...
USE_SMUXCTL(APPLET(smuxctl, _BB_DIR_SBIN, _BB_SUID_NEVER))
...
/*Start of Maintain 2008-3-1 17:11 for 修改Busybox中的传输工具，满足cwmp传输需求 by z65940*/
USE_ATP_TFTP(APPLET(tftp, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
/*End of Maintain 2008-3-1 17:11 for 修改Busybox中的传输工具，满足cwmp传输需求 by z65940*/
USE_TFTPD(APPLET_NOUSAGE(tftpd, tftpd, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
// start of add by d00107688 2012-03-19 支持mpstat查看双核CPU占用率
USE_MPSTAT(APPLET(mpstat, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
// end of add by d00107688 2012-03-19 支持mpstat查看双核CPU占用率
...
USE_ATP_TRACEROUTE6(APPLET(traceroute6, _BB_DIR_BIN, _BB_SUID_MAYBE))
...
USE_CONFIG_FLASH_ERASEALL(APPLET(flash_eraseall, _BB_DIR_SBIN, _BB_SUID_NEVER))
USE_WC(APPLET(wc, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
/*Start of Maintain 2008-3-1 17:11 for 修改Busybox中的传输工具，满足cwmp传输需求 by z65940*/
USE_ATP_WGET(APPLET(wget, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
/*End of Maintain 2008-3-1 17:11 for 修改Busybox中的传输工具，满足cwmp传输需求 by z65940*/
/* Add by l00171355 for Bonding driver @ 2013-07-16 */
USE_ATP_IFENSLAVE(APPLET(ifenslave, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
/* Add end */
