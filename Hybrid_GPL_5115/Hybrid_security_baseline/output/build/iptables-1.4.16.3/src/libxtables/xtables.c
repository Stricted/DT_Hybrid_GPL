...
/******************************************************************************
  函数名称  : ATP_UTIL_LockProc
  功能描述  : 根据指定文件名上文件锁，用于保障进程串行执行
  输入参数  : psLockFile:进程文件锁名
  调用函数  : 
  被调函数  : 
  输出参数  : 无
  返 回 值  :  NULL失败; 非空成功
...
/******************************************************************************
  函数名称  : ATP_UTIL_UnLockProc
  功能描述  : 文件解锁，用于保障进程串行执行
  输入参数  : fpLockFile:文件锁流输入
  调用函数  : 
  被调函数  : 
  输出参数  : 无
  返 回 值  :  -1失败; 0 成功
...
/******************************************************************************
  函数名称  : ATP_UTIL_RegUnLock
  功能描述  : 注册进程退出前的解锁操作
  输入参数  : pstProcLockInfo:进程锁信息
  调用函数  : 
  被调函数  : 
  输出参数  : 无
  返 回 值  :  
