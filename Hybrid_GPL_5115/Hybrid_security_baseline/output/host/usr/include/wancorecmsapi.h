...
/* <DTS2012081707617 w00189185 2012/8/28 begin  */
#ifdef SUPPORT_ATP_ATP_FMCWEB        
#define ATP_WAN_STR_NONE           "NONE"
#endif        
/* DTS2012081707617 w00189185 2012/8/28 end> */
...
typedef enum
{
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_ROUTESTART=1,
    ...
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_ALGSIPSIG,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_SIPSTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_DDNSSTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_IGMPPROXYRESET,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_PTWANRULSTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_VPNWANRULESTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_VPNL2TPSTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_ETHERIPROUTESTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_CWMPSTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_DEFAULTROUTING,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_VOICESTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_6TO4TUNNELSTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_6RDTUNNELSTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_FIREWALLWANSTART6,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_ACLWANSTART6,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_SNTP,    
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_CLEANTRACENAT,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_LED,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_FONSTART,
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANUP_FTPFIREWALLSTART,
...
typedef enum
{
    ATP_WAN_NOTIFY_PRIORITY_PREROUTEDWANDOWN_DNSDELETE=1,
    ...
    ATP_WAN_NOTIFY_PRIORITY_PREROUTEDWANDOWN_LEDSTOP,
...
typedef enum
{
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANDOWN_CWMPSTOP=1,
    /* <DTS2012091203320 z81004485 2012/9/12 begin  */
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANDOWN_LEDSTOP,
    /* DTS2012091203320 z81004485 2012/9/12 end> */
    ...
    ATP_WAN_NOTIFY_PRIORITY_ROUTEDWANDOWN_6TO4TUNNELSTOP,
...
typedef enum
{
    ATP_WAN_NOTIFY_PRIORITY_WANIPv6UPPROCESS_ROUTESTART=1,
    ...
    ATP_WAN_NOTIFY_PRIORITY_WANIPv6UPPROCESS_SNTP,    
    ATP_WAN_NOTIFY_PRIORITY_WANIPv6UPPROCESS_DSLITETUNNELSTART,
    ATP_WAN_NOTIFY_PRIORITY_WANIPv6UPPROCESS_LED,   
...
typedef enum
{
    ATP_WAN_NOTIFY_PRIORITY_WANIPv6DOWNPROCESS_MLDPROXYRESET=1,
...
typedef enum
{
    ATP_WAN_NOTIFY_PRIORITY_WANIPv6UPDATEPROCESS_DNSRESTART=1,
    ...
    ATP_WAN_NOTIFY_PRIORITY_WANIPv6UPDATEPROCESS_LED,
...
typedef enum
{
    ...
    ATP_WAN_NOTIFY_PRIORITY_PREWANIPV6UPDATEINFO_LEDSTOP,
...
VOS_UINT32 WanIpv6ConnectingNotifyInit();
VOS_UINT32 ATP_WAN_WanIpv6Connecting_NotifyRegister(AtpNotifierProc pfProc, VOS_UINT32 ulPriority, VOS_VOID *pvNotifyHook);
VOS_UINT32 WanIpv6ConnectingNotifierDoNotify(VOS_CHAR* pszWanPath);
VOS_UINT32 WanIpv6ConnectFailNotifyInit();
VOS_UINT32 ATP_WAN_WanIpv6ConnectFail_NotifyRegister(AtpNotifierProc pfProc, VOS_UINT32 ulPriority, VOS_VOID *pvNotifyHook);
VOS_UINT32 WanIpv6ConnectFailNotifierDoNotify(VOS_CHAR* pszWanPath);
