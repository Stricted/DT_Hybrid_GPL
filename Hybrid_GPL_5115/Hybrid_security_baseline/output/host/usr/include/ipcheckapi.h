...
/* <DTS2012092806859 z00189398 2012-10-22 begin */
#define MAX_LAN_PORT  (4)
#define MAX_LAN_NAME  (8)

typedef struct lanPortStatus
{
    VOS_CHAR sInterface[MAX_LAN_NAME];
    VOS_BOOL  state;
}LanPortState;
/* DTS2012092806859 z00189398 2012-10-22 end> */
...
#define ATP_IPCHECK_DETECT_PERIOD_D     (30 * 60)       // 30 minutes
...
/** Adapt function */
extern VOS_UINT32 ATP_IPCHECK_AdaptSyncDB(VOS_VOID);
