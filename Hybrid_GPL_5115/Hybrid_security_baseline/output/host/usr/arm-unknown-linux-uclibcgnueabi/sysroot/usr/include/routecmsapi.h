...
/*!
  ...
  \retval VOS_NOK 执行失败
*/
VOS_UINT32 ATP_ROUTE_Init(VOS_VOID *pcWanPath, VOS_VOID *pvHook);
/*!
  \brief 启动某条WAN的路由配置
...
/*!
  ...
  \retval ATP_E_ERR_CFM_SHM_NOT_ATTACH 初始化共享内存失败
*/
VOS_UINT32 ATP_WAN_GetGateWay(VOS_CHAR* acIfName, VOS_UINT32 ulIfcLen, VOS_CHAR* pszInterface );
VOS_UINT32 ATP_WAN_GetMask(VOS_CHAR* acIfName, VOS_UINT32 ulIfcLen, VOS_CHAR* pszInterface);
