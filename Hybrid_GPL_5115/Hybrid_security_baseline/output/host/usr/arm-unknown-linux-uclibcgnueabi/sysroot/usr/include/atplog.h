...
typedef struct
{
    VOS_CHAR   *switchfilepath;    /** 日志开关存放的文件路径 */
    VOS_CHAR   *pidpath;    /** 目标进程pid存放的路径 */
    VOS_UINT32 sig_number;    /** 信号 */
}ST_PARAM_LIST;
...
typedef struct
{
    char *module_name;
    VOS_UINT32 oid;
    EN_NOTIFY_TYPE signal_or_socket;    /** logswitch开关是使用信号还是socket消息 */
    ST_PARAM_LIST para;
}ST_MOUDLE_NAME;
