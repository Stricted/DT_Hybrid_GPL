...
VOS_UINT32 ATP_DBAliasToInstanceDomain(const VOS_CHAR* pcAliasDomainName, VOS_CHAR *pcInstDomainName);
...
VOS_VOID   ATP_DB_ALIAS_FreeStrongRefParaNameList(ATP_UTIL_LIST_ST *pstItem);
...
VOS_UINT32 ATP_DB_ALIAS_GetRefValuesByAliasMode(VOS_UINT32 ulOID,
...
/* <DTS2013050908318 j81004134 2013/5/18 begin */
VOS_BOOL ATP_CFM_IsObjectExist_for_MacFilter(const VOS_UINT32 ulKeyList[ATP_CFM_MAX_TREE_DEPTH], VOS_UINT32 ulObjID,
                                                              const VOS_UINT32 *pulSetValues, const VOS_UINT32 ulInstNum, CfmObjCompareProc pfProc, VOS_VOID *pvHook);
/* DTS2013050908318 j81004134 2013/5/18 end> */
