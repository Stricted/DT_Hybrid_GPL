...
/* <DTS2013050301791 z81004143 2013/5/7 begin */
#ifdef ATP_DEBUG
#define ATP_CWMP_DEBUG(format, args...)       {printf("[cwmp]%s[%d]%s: ", __FILE__, __LINE__, __FUNCTION__);printf(format, ##args);}
#else
#define ATP_CWMP_DEBUG(x...)
#endif
/* DTS2013050301791 z81004143 2013/5/7 end> */
