...
/* DTS2012082004703 add by wangpu 2012/08/21 begin */
typedef enum
{
        BHAL_WAN_MAC_MIN_INDX = 1,                    /*WAN接口MAC*/        
        BHAL_WAN_MAC_MAX_INDX = 4,                    /*WAN接口MAC*/        
        BHAL_WLAN_MAC_MIN_INDX = 5,                    /*WLAN接口MAC*/        
        BHAL_WLAN_MAC_MAX_INDX = 8,                    /*WLAN接口MAC*/        
}BHAL_MAC_TYPE_MIN_MAX_EN;
/* DTS2012082004703 add by wangpu 2012/08/21 end */
...
{   
    ...
    BHAL_LED_WirelessReset,
    BHAL_LED_WirelessFastboot,
    BHAL_LED_RouterPowerlock,    
...
typedef struct
{
    ...
    char szSsid[BHAL_SSID_LEN];                 //16
    char szWlpwd[BHAL_WLAN_PWD_LEN];            //16
    char szAppcode[BHAL_APPINCODE_LEN];         //32
    char szWeppwd[BHAL_WEP_PWD_LEN];            //128
    char szSsid5G[BHAL_SSID_LEN];               //16
    char szWlpwd5G[BHAL_WLAN_PWD_LEN];          //16
    char szAppcode5G[BHAL_APPINCODE_LEN];       //32
    char szWeppwd5G[BHAL_WEP_PWD_LEN];          //128
    char szUsrpwd[BHAL_USER_PWD_LEN];           //64
    char szUsrName[BHAL_USER_NAME_LEN];           //16
