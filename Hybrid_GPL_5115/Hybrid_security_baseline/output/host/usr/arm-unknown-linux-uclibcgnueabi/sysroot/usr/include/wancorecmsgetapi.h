...
*/
VOS_UINT32 ATP_WAN_GetProtocol(VOS_CHAR* pszPath, VOS_UINT32* pulProtocol);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetMSS(VOS_CHAR* pszPath, VOS_UINT32* pulMss);
#endif
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetConnInterfaceAlias(VOS_CHAR* pszPath, VOS_UINT32 ulIntAliasLen, VOS_CHAR* pszIntAlias);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetConnType(VOS_CHAR* pszPath, VOS_UINT32* pulConnType);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetServiceEnable(VOS_CHAR* pszPath, VOS_UINT8* pucEnable);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetNatEnable(VOS_CHAR* pszPath, VOS_UINT8* pucNatEnable);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetStatus(VOS_CHAR* pszPath, VOS_UINT32* pulStatus);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetStatus6(VOS_CHAR* pszPath, VOS_UINT32* pulStatus);
#endif
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetMask(VOS_CHAR* pszPath, VOS_UINT32 ulSubMaskLen, VOS_CHAR *pszSubMask);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetGateWay(VOS_CHAR* pszPath, VOS_UINT32 ulGateWayLen, VOS_CHAR* pszGateWay);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetDns(VOS_CHAR* pszPath, VOS_UINT32 ulDnsLen, VOS_CHAR* pszPrimaryDns, VOS_CHAR* pszSecondDns);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetStatistics(VOS_UINT32 ulWdInstId, ATP_WAN_STATS_ST* pstStats);
...
*/
VOS_BOOL ATP_WAN_ValidatePath(VOS_CHAR* pszPath);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetInstIdByPath(VOS_CHAR* pszPath, VOS_UINT32* pulWdInstId, VOS_UINT32* pulWcdInstId, VOS_UINT32* pulWanInstId, VOS_UINT32* pulWanCmoId);
...
/*!
  ...
  \retval 成功VOS_OK，失败ATP_ERR_WAN_EN
*/
VOS_UINT32 ATP_WAN_GetInstList(VOS_CHAR* pszPath,  VOS_UINT32 *pulKeyList, VOS_UINT32 *pulWanCmo);
...
VOS_BOOL ATP_WAN_Judge_Connected(ATP_WAN_INFO_ST* pstWan);
VOS_BOOL ATP_WAN_Contain_Servicelist(ATP_WAN_INFO_ST* pstWan, VOS_CHAR* pstServicelist);
VOS_BOOL ATP_WAN_Is_Same_Path(ATP_WAN_INFO_ST* pstOldWan, ATP_WAN_INFO_ST* pstNewWan);
...
VOS_BOOL ATP_WAN_Judge_Connected_Ipv6(ATP_WAN_INFO_ST* pstWan);
#endif
