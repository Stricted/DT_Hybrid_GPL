...
int main(int argc, char **argv)
{
	...
	if ((NULL == strstr(argv[0], "-ar")) && (NULL == strstr(argv[0], "-ranlib")) && (NULL == strstr(argv[0], "-strip")) && (NULL == strstr(argv[0], "-nm"))&& (NULL == strstr(argv[0], "-objdump"))&&(NULL == strstr(argv[0], "-objcopy")) && (NULL == strstr(argv[0], "-readelf"))) {
