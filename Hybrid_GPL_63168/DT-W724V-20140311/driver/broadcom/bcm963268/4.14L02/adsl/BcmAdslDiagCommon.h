...
typedef struct {
	...
	diagSockFrameDataAlign		dataFrame;
#else
...
typedef struct {
	ulong			diagMaxLpPerSrvCnt;
	ulong			diagDmaErrorCnt;
	ulong			diagDmaTotalDataLen;

	ulong			diagDataMap;
	ulong			diagLogTime;
	ulong			diagTotalBufNum;

	ulong			diagDmaIntrCnt;
	ulong			diagDmaBlockCnt;
	ulong			diagDmaOvrCnt;
	ulong			diagDmaSeqBlockNum;
	ulong			diagDmaSeqErrCnt;
	ulong			diagDmaBlockWrCnt;
	ulong			diagDmaBlockWrErrCnt;
	ulong			diagDmaBlockWrBusy;
	...
	diagDmaBlock	*diagStartBlock;
	diagDmaBlock	*diagWriteBlock;
	diagDmaBlock	*diagCurrBlock;
	diagDmaBlock	*diagEndBlock;
	diagDmaBlock	*diagEyeBlock;

	adslDmaDesc     *diagDescTbl;
	adslDmaDesc     *diagDescTblUC;
} diagCtrlType;
...
dslDrvSkbPool * DevSkbAllocate(struct sk_buff *model,
	...
	int dataAlignMask, int frameHeaderLength);
...
void __BcmAdslCoreDiagDmaInit(void);
void BcmAdslCoreDiagDataFlush(void);
void BcmAdslCoreDiagDmaUninit(void);
