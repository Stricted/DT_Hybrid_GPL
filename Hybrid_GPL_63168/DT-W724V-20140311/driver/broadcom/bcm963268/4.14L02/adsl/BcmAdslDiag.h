...
#endif
void BcmAdslCoreDiagStartLog_1(unsigned long map, unsigned long time);
void BcmAdslCoreDiagStartLog_2(unsigned long map, unsigned long time);
...
int  BcmCoreDiagLogActive(ulong map);
