...
#define PAGE_CONTROL                                      0x00
    ...
    #define NUM_RGMII_PORTS  1
    #define RGMII_PORT_ID    4
#elif defined (CONFIG_BCM968500) || defined(CONFIG_BCM96838)
    #define EPHY_PORTS       0
    #define GPON_PORT_ID     7
    #define WAN_PORT_ID      4
...
****************************************************************************/
    #define PAGE_STATUS                                 0x01
        #define BCM_LINK_STATUS_SUM                     0x00
        #define BCM_SPEED_STATUS_SUM                    0x04
        #define BCM_DUPLEX_STATUS_SUM                   0x08
