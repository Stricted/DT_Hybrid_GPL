...
#define BSD_ENTER()	BSD_INFO("Enter...\n")
#define BSD_EXIT() 	BSD_INFO("Exit...\n")
...
typedef struct bsd_info {
	...
	uint8 status_poll;
	uint8 counter_poll, idle_rate; /* hack:jhc */
...
extern bsd_sta_info_t *bsd_default_algo(bsd_info_t *info);
extern void bsd_update_stainfo(bsd_info_t *info);

extern void bsd_update_stb_info(bsd_info_t *info); /* hack: jhc */
