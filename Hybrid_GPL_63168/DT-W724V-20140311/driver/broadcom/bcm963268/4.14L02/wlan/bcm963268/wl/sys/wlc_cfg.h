 ...
 *
 * $Id: wlc_cfg.h 409124 2013-06-22 04:35:15Z $
 */
...
#define _IS_SINGLEBAND_5G_RELEASEDCHIP(device) \
	...
	#define _IS_SINGLEBAND_5G(device)       (_IS_SINGLEBAND_5G_RELEASEDCHIP(device))


int wlc_is_singleband_5g(unsigned int device);
int wlc_bmac_is_singleband_5g(unsigned int device);
#ifndef IS_SINGLEBAND_5G_4335C0_ROM_COMPAT
	#if defined(WLC_HIGH)
		#define IS_SINGLEBAND_5G(device)	wlc_is_singleband_5g(device)
	#elif defined(WLC_LOW)
		#define IS_SINGLEBAND_5G(device)	wlc_bmac_is_singleband_5g(device)
	#endif
#endif /* IS_SINGLEBAND_5G_4335C0_ROM_COMPAT */
...
#define D11_DEFAULT2	0x0000ff27	/* Supported  D11 revs: 32-34, 37, 40-47 */
...
#  if (defined(ACCONF) || defined(LCN40CONF) || defined(LCNCONF) || defined(SSLPNCONF) \
	|| defined(LPCONF) || defined(NCONF) || defined(HTCONF) || defined(ACONF) || \
	defined(GCONF))
...
#  endif /* ACCONF || LCN40CONF || LCNCONF || SSLPNCONF || LPCONF ||
	 ** NCONF || HTCONF || ACONF || GCONF
	 */
...
#define LCN40PHY_DEFAULT	0x0000004f	/* Supported lcn40phy revs:
						 ...
						 *
						 */
#define ACPHY_DEFAULT		0x00001ff       /* Supported acphy revs:
						 *
						 *
						 *
						 *
...
#error "WLAMPDU_HOSTREORDER requires PROP_TXSTATUS"
#endif
...
#if defined(WLCHANIM) && defined(CCA_STATS) && defined(ISID_STATS)
#error "wlc_weakest_link_rssi_chan_stats_upd assumes these flags, WLCHANIM & CCA_STAT cant coexist"
#endif
...
#ifndef MAXBSS
#if defined(NDIS620) || defined(NDIS630) || defined(NDIS640)
#define MAXBSS		128	/* max # available networks */
#else
#define MAXBSS		64	/* max # available networks */
#endif /* NDIS620 || NDIS630 || NDIS640 */
#endif /* MAXBSS */
...
/* VHT 3x3 and 2x2 tunable value defaults. */
#ifndef NTXD_AC3X3
...
/* VHT 3x3 and 2x2 tunable value defaults for large rings (max 4K). */
#ifndef NTXD_LARGE_AC3X3
#define NTXD_LARGE_AC3X3	1024	/* TX descriptor ring */
#endif

#ifndef NRXD_LARGE_AC3X3
#define NRXD_LARGE_AC3X3	1024	/* RX descriptor ring */
#endif

#ifndef NRXBUFPOST_LARGE_AC3X3
#define NRXBUFPOST_LARGE_AC3X3	256	/* # rx buffers posted */
#endif

#ifndef RXBND_LARGE_AC3X3
#define RXBND_LARGE_AC3X3		32	/* max # rx frames to process */
#endif
