...
#define BREG_Write32(c,x,y)   do { reg_write_count++; *(volatile uint32_t *)(x) = y; } while(0)
#else
#define BREG_Read32(c,x)      (*(volatile uint32_t *)(x))
#define BREG_Write32(c,x,y)   do {*(volatile uint32_t *)(x) = y; } while(0)
#endif
#endif
