#ifndef __FAP_HW_6828_H_INCLUDED__
#define __FAP_HW_6828_H_INCLUDED__
...
#ifdef USE_SMISBUS
#define PHYS_FAP_BASE_0           0x10c01000 /* 6828 using SMISBUS */
#define PHYS_FAP_BASE_1           0x10e01000 /* 6828 using SMISBUS */
#else
#define PHYS_FAP_BASE_0           FAP0_CNTRL_BASE /* 6828 using UBUS    */
#define PHYS_FAP_BASE_1           FAP1_CNTRL_BASE /* 6828 using UBUS    */
#endif /* USE_SMISBUS */
...
static const uint32 FAP_INTERRUPT_IRQS[]       = { 30, 31 };
...
#define hostHwCntrReg(fapIdx)        ((volatile HwCntrs_S *)(NON_CACHE_VIRT_FAP_BASES[fapIdx] + HW_CNTR_OFFSET))
...
#endif  /* defined(__FAP_HW_6828_H_INCLUDED__) */
