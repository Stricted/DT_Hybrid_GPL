...
`sed s/'#define DSP_CORE_SIZE .*'/"#define DSP_CORE_SIZE $coreSize"/g $2/dsp_mod_size.h > $2/dsp_mod_size1.h`
`mv -f $2/dsp_mod_size1.h $2/dsp_mod_size.h`
`sed s/'#define DSP_INIT_SIZE .*'/"#define DSP_INIT_SIZE $initSize"/g $2/dsp_mod_size.h > $2/dsp_mod_size1.h`
`mv -f $2/dsp_mod_size1.h $2/dsp_mod_size.h`
