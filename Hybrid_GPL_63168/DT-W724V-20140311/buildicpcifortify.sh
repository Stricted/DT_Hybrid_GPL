...
ATPICPCITQEFORTIFYPARAMETER="ATP_CI_TQE_FORTIFY=y"
...
echo "make ${VENDORPARAMETER} ${CUSTOMERPARAMETER} ${ATPICPCIPARAMETER} ${ATPICPCITQEPARAMETER} ${ATPICPCITQEFORTIFYPARAMETER} ${COMPILETARGETS}"
make ${VENDORPARAMETER} ${CUSTOMERPARAMETER} ${ATPICPCIPARAMETER} ${ATPICPCITQEPARAMETER} ${ATPICPCITQEFORTIFYPARAMETER} ${COMPILETARGETS}
