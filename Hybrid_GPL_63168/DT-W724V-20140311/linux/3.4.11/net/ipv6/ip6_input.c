...
#ifdef CONFIG_ATP_HYBRID
    /*Start of Protocol 2014-3-26 21:13 for 路由机制修改 by t00189036*/
    struct nf_conn *nfct = (struct nf_conn *)skb->nfct;
    if (nfct)
    {
        skb->mark |= (nfct->mark & HYBRID_FWMARK_FILTER_MASK);
    }
    /*End of Protocol 2014-3-26 21:13 for 路由机制修改 by t00189036*/
#endif
