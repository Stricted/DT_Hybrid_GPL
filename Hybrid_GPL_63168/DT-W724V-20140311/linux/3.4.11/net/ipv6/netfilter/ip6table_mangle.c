...
/*Start of Protocol 2014-4-24 10:53 for DTS2014032806341:网关自身业务的平滑切换 by t00189036*/
#ifdef CONFIG_ATP_HYBRID
#include <net/netfilter/nf_conntrack.h>
#endif
/*End of Protocol 2014-4-24 10:53 for by t00189036*/
...
/*Start of Protocol 2014-4-24 10:54 for DTS2014032806341:网关自身业务的平滑切换 by t00189036*/
    ...
    if (!(skb->mark & ATP_CONNTRACK_FLOW_MARK_MASK)
        && (nfct && (nfct->mark & ATP_CONNTRACK_FLOW_MARK_MASK)))
    {
...
/*End of Protocol 2014-4-24 10:54 for by t00189036*/
	...
	if (ret != NF_DROP && ret != NF_STOLEN &&
        (IPPROTO_GRE != ipv6_hdr(skb)->nexthdr) && 
