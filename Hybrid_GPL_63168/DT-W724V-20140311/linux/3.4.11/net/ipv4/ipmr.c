    ...
    __be32 origin, __be32 mcastgrp, struct net_device *pstDev)
{
    ...
    /*START MODIFY:l00180987 2012-11-20 FOR igmp proxy无法组播，返回非法cache引发cpu 0*/
    ...
    return NULL;
    /*END MODIFY:l00180987 2012-11-20 FOR igmp proxy无法组播，返回非法cache引发cpu 0*/
}
#endif
...
#elif defined(CONFIG_ATP_COMMON)
