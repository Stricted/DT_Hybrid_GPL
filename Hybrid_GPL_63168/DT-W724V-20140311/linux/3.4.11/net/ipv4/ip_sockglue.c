...
/*Start of Protocol 2014-4-29 16:41 for 支持接收报文的mark by t00189036*/
#define IP_CMSG_MARK     128
/*End of Protocol 2014-4-29 16:41 for by t00189036*/
#endif
...
#ifdef CONFIG_ATP_HYBRID
/*Start of Protocol 2014-4-29 16:42 for 支持接收报文的mark by t00189036*/
static void ip_cmsg_recv_mark(struct msghdr *msg, struct sk_buff *skb)
{
	put_cmsg(msg, SOL_IP, IP_MARK, sizeof(__u32), &skb->mark);
}
/*End of Protocol 2014-4-29 16:42 for by t00189036*/
#endif
...
mc_msf_out:
	...
	case MCAST_SSM_ADD:
	    ...
	    printk("recv MCAST_SSM_ADD opt\n");
	    err = ip_mc_add_ssm((__be32)val);
#endif
    	break;
	case MCAST_SSM_DEL:
#ifdef CONFIG_ATP_IGMP_SSM
    	printk("recv MCAST_SSM_DEL opt\n");
	    err = ip_mc_del_ssm((__be32)val);
#endif
    	break;
	case MCAST_ASM_ADD:
#ifdef CONFIG_ATP_IGMP_SSM
	    printk("recv MCAST_ASM_ADD opt\n");
	    err = ip_mc_add_asm((__be32)val);
#endif
    	break;
	case MCAST_ASM_DEL:
#ifdef CONFIG_ATP_IGMP_SSM
    	printk("recv MCAST_ASM_DEL opt\n");
			    ...
			    char __user *optval, int __user *optlen, unsigned flags)
{
	...
	case IP_RECVTOS:
		...
		break;
#ifdef CONFIG_ATP_HYBRID
    /*Start of Protocol 2014-4-29 16:43 for 支持接收报文的mark by t00189036*/
    case IP_RECVMARK:
        val = (inet->cmsg_flags & IP_CMSG_MARK) != 0;
        break;
    /*End of Protocol 2014-4-29 16:43 for by t00189036*/
#endif
	case IP_RECVOPTS:
