...
int l2tp_xmit_skb(struct l2tp_session *session, struct sk_buff *skb, int hdr_len)
{
    ...
    /* BEGIN: add for DTS2013111800671 FON: l2tp隧道内的ppp包无法发送 by l00214441 2013.11.18 */ 
    ...
    /* END: add for DTS2013111800671 FON: l2tp隧道内的ppp包无法发送 by l00214441 2013.11.18 */ 
#endif
	...
	case L2TP_ENCAPTYPE_UDP:
		...
		if (sk->sk_no_check == UDP_CSUM_NOXMIT)
    		...
    		uh->check = csum_tcpudp_magic(skb_rtable(skb)->rt_src, 
    		                  skb_rtable(skb)->rt_dst, /* 由于inet->saddr不是实际的源IP，导致udp校验和不对 */
...
static void l2tp_tunnel_free(struct l2tp_tunnel *tunnel)
{
    ...
    /* BEGIN: add for DTS2013111801731 FON: 隧道断开时，内核cpu0 by l00214441 2013.11.12 */ 
	...
	synchronize_rcu();
#endif
    /* END: add for DTS2013111801731 FON: 隧道断开时，内核cpu0 by l00214441 2013.11.12 */ 
