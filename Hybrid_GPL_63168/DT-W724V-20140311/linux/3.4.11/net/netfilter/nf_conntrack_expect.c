...
void nf_ct_remove_expectations(struct nf_conn *ct)
{
    ...
    /*START ADD: l00252599 FOR DTS2014053105317 2014-06-05*/	
#ifdef CONFIG_ATP_COMMON	
    struct timer_list *timer = NULL;
	struct list_head *entry = NULL;
#endif
    /*END ADD: l00252599 FOR DTS2014053105317 2014-06-05*/
	...
	hlist_for_each_entry_safe(exp, n, next, &help->expectations, lnode) {
        ...
        if (LIST_POISON2 == entry->prev)
        {
            printk("__Func: %s $$$$$$$$$$$$$$$$$$ __Line: %d \r\n", __FUNCTION__, __LINE__);
            return;
        }
#endif
        /*END ADD: l00252599 FOR DTS2014053105317 2014-06-05*/
...
int nf_conntrack_expect_init(struct net *net)
{
	...
	/*Fix me by l00180987:如需根据是否启用ConeNat决定预期连接个数，建议在用户空间设置*/
#if defined(CONFIG_IP_NF_TARGET_CONENAT) || defined(CONFIG_IP_NF_TARGET_MASQUERADE)
