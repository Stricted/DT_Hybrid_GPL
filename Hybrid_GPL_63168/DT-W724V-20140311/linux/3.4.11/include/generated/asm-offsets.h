...
#define TASK_FLAGS 16 /* offsetof(struct task_struct, flags)	 # */
#define TASK_MM 212 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 248 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STRUCT_SIZE 1096 /* sizeof(struct task_struct)	 # */
...
#define THREAD_REG16 496 /* offsetof(struct task_struct, thread.reg16)	 # */
#define THREAD_REG17 500 /* offsetof(struct task_struct, thread.reg17)	 # */
#define THREAD_REG18 504 /* offsetof(struct task_struct, thread.reg18)	 # */
#define THREAD_REG19 508 /* offsetof(struct task_struct, thread.reg19)	 # */
#define THREAD_REG20 512 /* offsetof(struct task_struct, thread.reg20)	 # */
#define THREAD_REG21 516 /* offsetof(struct task_struct, thread.reg21)	 # */
#define THREAD_REG22 520 /* offsetof(struct task_struct, thread.reg22)	 # */
#define THREAD_REG23 524 /* offsetof(struct task_struct, thread.reg23)	 # */
#define THREAD_REG29 528 /* offsetof(struct task_struct, thread.reg29)	 # */
#define THREAD_REG30 532 /* offsetof(struct task_struct, thread.reg30)	 # */
#define THREAD_REG31 536 /* offsetof(struct task_struct, thread.reg31)	 # */
#define THREAD_STATUS 540 /* offsetof(struct task_struct, thread.cp0_status)	 # */
#define THREAD_FPU 544 /* offsetof(struct task_struct, thread.fpu)	 # */
#define THREAD_BVADDR 860 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 864 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 868 /* offsetof(struct task_struct, thread.error_code)	 # */
#define THREAD_TRAMP 872 /* offsetof(struct task_struct, thread.irix_trampoline)	 # */
#define THREAD_OLDCTX 876 /* offsetof(struct task_struct, thread.irix_oldctx)	 # */

#define THREAD_FPR0 544 /* offsetof(struct task_struct, thread.fpu.fpr[0])	 # */
#define THREAD_FPR1 552 /* offsetof(struct task_struct, thread.fpu.fpr[1])	 # */
#define THREAD_FPR2 560 /* offsetof(struct task_struct, thread.fpu.fpr[2])	 # */
#define THREAD_FPR3 568 /* offsetof(struct task_struct, thread.fpu.fpr[3])	 # */
#define THREAD_FPR4 576 /* offsetof(struct task_struct, thread.fpu.fpr[4])	 # */
#define THREAD_FPR5 584 /* offsetof(struct task_struct, thread.fpu.fpr[5])	 # */
#define THREAD_FPR6 592 /* offsetof(struct task_struct, thread.fpu.fpr[6])	 # */
#define THREAD_FPR7 600 /* offsetof(struct task_struct, thread.fpu.fpr[7])	 # */
#define THREAD_FPR8 608 /* offsetof(struct task_struct, thread.fpu.fpr[8])	 # */
#define THREAD_FPR9 616 /* offsetof(struct task_struct, thread.fpu.fpr[9])	 # */
#define THREAD_FPR10 624 /* offsetof(struct task_struct, thread.fpu.fpr[10])	 # */
#define THREAD_FPR11 632 /* offsetof(struct task_struct, thread.fpu.fpr[11])	 # */
#define THREAD_FPR12 640 /* offsetof(struct task_struct, thread.fpu.fpr[12])	 # */
#define THREAD_FPR13 648 /* offsetof(struct task_struct, thread.fpu.fpr[13])	 # */
#define THREAD_FPR14 656 /* offsetof(struct task_struct, thread.fpu.fpr[14])	 # */
#define THREAD_FPR15 664 /* offsetof(struct task_struct, thread.fpu.fpr[15])	 # */
#define THREAD_FPR16 672 /* offsetof(struct task_struct, thread.fpu.fpr[16])	 # */
#define THREAD_FPR17 680 /* offsetof(struct task_struct, thread.fpu.fpr[17])	 # */
#define THREAD_FPR18 688 /* offsetof(struct task_struct, thread.fpu.fpr[18])	 # */
#define THREAD_FPR19 696 /* offsetof(struct task_struct, thread.fpu.fpr[19])	 # */
#define THREAD_FPR20 704 /* offsetof(struct task_struct, thread.fpu.fpr[20])	 # */
#define THREAD_FPR21 712 /* offsetof(struct task_struct, thread.fpu.fpr[21])	 # */
#define THREAD_FPR22 720 /* offsetof(struct task_struct, thread.fpu.fpr[22])	 # */
#define THREAD_FPR23 728 /* offsetof(struct task_struct, thread.fpu.fpr[23])	 # */
#define THREAD_FPR24 736 /* offsetof(struct task_struct, thread.fpu.fpr[24])	 # */
#define THREAD_FPR25 744 /* offsetof(struct task_struct, thread.fpu.fpr[25])	 # */
#define THREAD_FPR26 752 /* offsetof(struct task_struct, thread.fpu.fpr[26])	 # */
#define THREAD_FPR27 760 /* offsetof(struct task_struct, thread.fpu.fpr[27])	 # */
#define THREAD_FPR28 768 /* offsetof(struct task_struct, thread.fpu.fpr[28])	 # */
#define THREAD_FPR29 776 /* offsetof(struct task_struct, thread.fpu.fpr[29])	 # */
#define THREAD_FPR30 784 /* offsetof(struct task_struct, thread.fpu.fpr[30])	 # */
#define THREAD_FPR31 792 /* offsetof(struct task_struct, thread.fpu.fpr[31])	 # */
#define THREAD_FCR31 800 /* offsetof(struct task_struct, thread.fpu.fcr31)	 # */
...
#define IC_IRQ_CPUSTAT_T 16 /* sizeof(irq_cpustat_t)	 # */
