 ...
 * default: 1s
 */
#if (defined(CONFIG_BCM_KF_MIPS_BCM963XX) || defined(CONFIG_BCM_KF_MIPS_BCM9685XX)) && (defined(CONFIG_MIPS_BCM963XX)|| defined(CONFIG_BCM968500))
 ...
 */
#if 0//def CONFIG_ATP_COMMON 去掉DEBUG打印
int g_show_wakeup = 0;
#endif
static int
...
static noinline void __schedule_bug(struct task_struct *prev)
{
	...
	always_printk(KERN_ERR "BUG: scheduling while atomic: %s/%d/0x%08x\n",
