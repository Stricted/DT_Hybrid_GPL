...
static const struct bin_table bin_net_ipv4_netfilter_table[] = {
	...
	{ CTL_INT,	NET_IPV4_NF_CONNTRACK_CLEAN,	"ip_ct_clean" },
	{ CTL_INT,	NET_IPV4_NF_CLEAN_DNS,	"ip_conntrack_dns" },
#endif
#ifdef CONFIG_ATP_COMMON
	{ CTL_INT,	NET_IPV4_NF_ALG_RTSP_SWITCH,	"alg_rtsp_enable" },
#endif
#if defined(CONFIG_IMQ) || defined(CONFIG_IMQ_MODULE) || defined(CONFIG_DT_QOS)
	{ CTL_INT,	NET_IPV4_NF_QOS_SWITCH,	"qos_enable" },
#endif
...
static const struct bin_table bin_net_ipv4_table[] = {
	...
	{ CTL_INT,  NET_IPV4_IGMP_QUERY_TOS,	 "igmp_query_tos" },
	{ CTL_INT,  NET_IPV4_IGMP_QUERY_QQIC,	 "igmp_query_qqic" },
	{ CTL_INT,  NET_IPV4_IGMP_QUERY_MRT,	 "igmp_query_mrt" },
	{ CTL_INT,  NET_IPV4_IGMP_QUERY_QRV,	 "igmp_query_qrv" },
#endif
...
#endif
#ifdef CONFIG_DT_QOS
	{ CTL_INT,  NET_IPV4_LAN_HOST_IP,	 "lan_host_ip" },
#endif
	...
	{ CTL_INT,	NET_IPV4_UDP_PORT_SCAN,	            "sysctl_port_scan" },
#endif
