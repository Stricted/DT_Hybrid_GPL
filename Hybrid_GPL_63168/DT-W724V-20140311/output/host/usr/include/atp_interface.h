...
#define FON_TRAFFIC_MARK    0x1

//用特殊的protol 255发netlink消息通知内核, 代替以前echo 36到ip_ct_clean的清连接方式
#define NAT_MAX_PROTOCOL  255
...
#define IS_GRE1_DEV(dev_name) \
    ('g' == dev_name[0]) && ('1' == dev_name[3])

#define IS_GRE2_DEV(dev_name) \
    ('g' == dev_name[0]) && ('2' == dev_name[3])
