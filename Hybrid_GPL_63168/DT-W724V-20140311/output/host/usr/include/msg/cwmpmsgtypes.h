...
#ifdef SUPPORT_ATP_CWMP_KEEP_PPP_ONLINE
        ATP_MSG_CWMP_PPPC_READY,
#endif
#endif
#ifdef SUPPORT_ATP_CWMP_TRIGGER_DNS_FRIST
        ATP_MSG_CWMP_SNTP_SYNC,
#endif
#ifdef SUPPORT_ATP_PERIODIC_STATISTIC
    ATP_MSG_SAMPLESET_VALUE_CHANGE
#endif
} ;
