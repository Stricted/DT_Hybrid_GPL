...
#define ATP_CBBID_PPPC_CMDLINE "pppc-Ippp256"


#ifdef SUPPORT_ATP_PPP_DYN_DIAL
#define TRIGGER_PPPC_FLAG_FILE  "/var/first_trigger"
#define RESTART_PPPC_FLAG_FILE "var/restart_flag"
#endif
...
enum ATP_MSGTYPES_EN
{
    ...
    ATP_MSG_WAN_V4_V6_WILLDOWN,
    ATP_MSG_WAN_V4_WILLDOWN,
    ATP_MSG_PPPC_VLAN_UNTAG,
    ATP_MSG_PPPC_STATUS_UPDATE,
} ;
