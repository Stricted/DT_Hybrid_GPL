...
#define ATP_TAB_RSS_INTERVAL_DEFAULTVAL                      21600
#define ATP_TAB_EMAIL_INTERVAL_DEFAULTVAL                    3600
...
#define ATP_TAB_EMAIL_STATUS_NAME                  "emailstatus"
...
#define ATP_TAB_EMAIL_SUBLIST_MAILNUM     "mailnumber"
#define ATP_TAB_EMAIL_SUBLIST_UID         "UID"             /*emailsublist*/
#define ATP_TAB_EMAIL_SUBLIST_DATE        "MailDatetime"        /*emailsublist*/
...
#define ATP_TAB_EMAIL_STATUS_ACCOUNTID    "account"         /*emailstatus*/
#define ATP_TAB_EMAIL_STATUS_UID          "UID"             /*emailstatus*/
#define ATP_TAB_EMAIL_STATUS_READ         "readstatus"      /*emailstatus*/
...
#define ATP_TAB_DECT_RSSSUBLIST_NAME       "rsssubtitlelist"   /*rss sublist for new vdb*/
#define ATP_TAB_DECT_RSSSUBLIST_CHANNELID  "channelID"
#define ATP_TAB_DECT_RSSSUBLIST_PUBTIME    "pubdateTime"
#define ATP_TAB_DECT_RSSSUBLIST_SQLTIME    "sqlDateTime"
#define ATP_TAB_DECT_RSSSUBLIST_TITLE      "sublistTitle"
#define ATP_TAB_DECT_RSSSUBLIST_TEXT       "sublistText"
#define ATP_TAB_DECT_RSSSUBLIST_URL        "sublistUrl"
#define ATP_TAB_DECT_RSSSUBLIST_RSTATUS    "readStatus"

#define ATP_VDB_DECT_RSSURLTIME_INFO       "rssgetfileinfo"
#define ATP_VDB_DECT_RSSCHANNEL_URL        "rssurl"
#define ATP_VDB_DECT_RSSLASTTIME_GET       "lastgettime"
#define ATP_VDB_DECT_RSSSESSIONID_LIST     "sessionidlist"
...
{
	ATP_VOICE_CONTACT_TYPE_FAX    = 0x01,
...
#define ATP_VOICE_CONTACT_DEFAULT   0x20
#define ATP_VOICE_CONTACT_OWN       0x10
...
{
	VDB_ENTRY_ID             llEntryID;                             /*Entry identifie*/         
    char                     acName[ATP_TAB_VOICE_256_LEN];    /*Name of the contact*/
    char                     acFstName[ATP_TAB_VOICE_256_LEN]; /*First name of the contact*/
...
typedef struct tagATP_TAB_VOICE_NETPB_ST
{
	VDB_ENTRY_ID             llEntryID;                             /*Entry identifie*/         
    char                     acName[ATP_TAB_VOICE_64_LEN];    		/*Name of the contact*/
    char                     acFstName[ATP_TAB_VOICE_64_LEN]; 		/*First name of the contact*/
    ATP_VOICE_CONTACT_NUM_ST stContactNum;                          /*Number of the contact*/
	char    				 acCity[ATP_TAB_VOICE_64_LEN];
	char    				 acStreet[ATP_TAB_VOICE_64_LEN];
	char    				 acZip[ATP_TAB_VOICE_32_LEN];				
	char    				 acBirthday[ATP_TAB_VOICE_32_LEN];  
}ATP_TAB_VOICE_NETPB_ST;
...
{
    VDB_ENTRY_ID    llEntryID;                              /*Entry identifie*/
    char            acName[ATP_TAB_VOICE_64_LEN];     /*Name of the line*/
...
typedef struct tagATP_TAB_DECTMAIL_ST
{
    ...
    char            acPassWord[ATP_TAB_VOICE_512_LEN];
} ATP_TAB_DECTMAIL_ST;
...
typedef struct tagATP_TAB_DECTRSS_ST
{
    ...
    char            acRSSName[ATP_TAB_VOICE_64_LEN];
...
typedef struct tagATP_TAB_DECTRSSSUB_ST
{
    ...
    char            acPubDateTime[ATP_TAB_VOICE_32_LEN];
    unsigned int    ulSqlDateTime;
    char            acSubListTitle[ATP_TAB_VOICE_128_LEN];
    char            acSubListText[ATP_TAB_VOICE_512_LEN];
    char            acSubListUrl[ATP_TAB_VOICE_256_LEN];
    unsigned int    ulReadStatus;
	unsigned int    ulAddSetFlag;
} ATP_TAB_DECTRSSSUB_ST;

typedef struct tagATP_TAB_DECTRSSREADCONTROL_ST
{
    VDB_ENTRY_ID    llEntryID;
    char            acRssUrl[ATP_TAB_VOICE_256_LEN];
    int             ulLastTime;
    char            acSessionList[ATP_TAB_VOICE_256_LEN];
} ATP_TAB_DECTRSSREADCONTROL_ST;


typedef enum tagATP_DECT_RSS_ADDSET_EN
{
    ATP_DECT_RSSSUBLIST_ADD,
    ATP_DECT_RSSSUBLIST_SET
} ATP_DECT_RSS_ADDSET_EN;

typedef struct tagATP_TAB_EMAIL_SUB_ST
{
    VDB_ENTRY_ID    llEntryID;                              /*Entry identifie*/
    VDB_ENTRY_ID    llAccountId;                            /*email account id*/
    VOS_UINT32      ulMailNumber;
    char            acUid[ATP_TAB_VOICE_128_LEN];           /*id of email list*/
...
typedef struct tagATP_TAB_EMAIL_STATUS_ST
{
    VDB_ENTRY_ID    llEntryID;                              /*Entry identifie*/
    VDB_ENTRY_ID    llAccountID;                            /*email account id*/
    char            acUid[ATP_TAB_VOICE_128_LEN];           /*id of email list*/
    int             lReadStatus;                            /*read status:0:unread;1:read*/
}ATP_TAB_EMAIL_STATUS_ST;
...
typedef enum tagATP_VDB_TABLE_ID_EN
{
    ...
    /* END:   Added by zengjun 182276, 2011/5/30 */
	ATP_VDB_TABLE_DECTRSS_SUBLIST,
	ATP_VDB_TABLE_DECTRSS_TIMECON,
    ATP_VDB_TABLE_EMAIL_SUBLIST,
    ATP_VDB_TABLE_EMAIL_STATUS,
	ATP_VDB_TABLE_MAX
} ATP_VDB_TABLE_ID_EN;
...
void *ATP_VDB_Init(void);
void *ATP_DummyVDB_Init(void);
void *ATP_DtVDB_Init();
