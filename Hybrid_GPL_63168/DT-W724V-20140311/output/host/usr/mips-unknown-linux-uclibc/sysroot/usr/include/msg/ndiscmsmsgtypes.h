#ifndef __ATP_NDISCMS_MSGTYPES_H__
#define __ATP_NDISCMS_MSGTYPES_H__

#define ATP_CBBID_NDISCMS_NAME    "ndis"
#define ATP_CBBID_TEST1_NAME                  "test1"
#define ATP_NDIS_MAX_LEN 256
#define ATP_MAC_LEN 6
#define ATP_NDIS_IPINTF_NAME "rmnet0"

enum ATP_NDISCMS_MSGTYPES_EN
{
    ATP_MSG_NDISCMS_START = ATP_MSG_CATEGORY_DEF(ATP_MODULE_NDISCMS),
    ATP_MSG_NDISCMS_WAN_CHG = ATP_MSG_NDISCMS_START,   /*!< NDISCMS消息开始 */
...
#endif // End of __ATP_NDISCMS_MSGTYPES_H__
