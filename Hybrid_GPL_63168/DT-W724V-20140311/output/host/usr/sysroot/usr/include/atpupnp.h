...
#define ATP_TR064V2_SSDP_ST             "urn:telekom-de:device:TO_InternetGatewayDevice:2"
...
#define ATP_UPNP_SSDP_INTERVAL_D       (20) // For DLNA 1.5 Certification.
...
#if defined(SUPPORT_ATP_UPNP_UPNP) && defined(SUPPORT_ATP_UPNP_TR064)
#define ATP_UPNP_DEVICE_SERVICE_OWNER ATP_DEVICE_SERVICE_OWNER_ALL
#elif defined(SUPPORT_ATP_UPNP_UPNP)
#define ATP_UPNP_DEVICE_SERVICE_OWNER ATP_DEVICE_SERVICE_OWNER_UPNP
#else
#define ATP_UPNP_DEVICE_SERVICE_OWNER ATP_DEVICE_SERVICE_OWNER_TR064
#endif
...
#define ATP_UPNP_AUTH_SAFE_MAXDENYSECONDS (64)
...
typedef struct tagATP_UPNP_DEVICE_DESC_ST
{
    ...
    VOS_CHAR            *pcTR064Version;
    VOS_CHAR            *pcTR064SecurePort;
...
typedef struct tagATP_UPNP_SHM_EXTENSION_ST
{
    ...
    struct addrinfo              *pstLocalAddr;
    //for safe protect.
#ifdef SUPPORT_ATP_AUTH_SAFE_PROTECT
    VOS_UINT32 ulDelayTime;
    VOS_UINT32 ulLastAuthFailTime;
#endif
