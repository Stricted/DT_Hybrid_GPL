...
int PwrMngtCtl_Initialize(PPWRMNGT_CONFIG_PARAMS pInitParms);
 ...
 * @return CmsRet enum.
 */
int PwrMngtCtl_Uninitialize(void);
 ...
 * @return CmsRet enum.
 */
int PwrMngtCtl_GetConfig(
    PPWRMNGT_CONFIG_PARAMS pCfgParams, unsigned long configMask);
 ...
 * @return CmsRet enum.
 */
int PwrMngtCtl_SetConfig(
    PPWRMNGT_CONFIG_PARAMS pCfgParams, unsigned long configMask, void *msgHandle);

/**Get low power status from PwrMngt driver
 *
 * This function is called to verify low power status 
 * for the ethernet and USB interfaces.
 *
 * @param pIfStatus (OUT) A pointer.
 * 
 * @return CmsRet enum.
 */

int  PwrMngtCtl_GetStatus( PPWRMNGT_IF_STATUS pIfStatus);
