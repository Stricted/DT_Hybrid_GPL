...
/* BEGIN: Added by chenlianhui, 2010/5/25 */
#define CS_CLIP_FLAG            "i"         /*打开来电显示标识*/
#define CS_CLIR_FLAG            "I"         /*关闭来电显示标识*/
/* END:   Added by chenlianhui, 2010/5/25 */
...
typedef enum _E_CS_CMD_TYPE
{
	...
	CS_CMD_TYPE_DTMF_SINGLE,                    /*DTMF 信令*/
...
{
    CS_USB_STATUS_FAULT,                    /*数据卡故障*/
    CS_USB_STATUS_OK,                       /*数据卡正常工作*/
    CS_USB_STATUS_FAULT_NODEV,              /*数据卡卡座未接入任何USB设备*/
    CS_USB_STATUS_FAULT_NOHSPASTICK,        /*数据卡卡座接入USB设备，但不是数据卡*/                                                                                       
    CS_USB_STATUS_BUTT,
}CS_USB_STATUS_E;
...
1   发送的DTMF音
******************************************************************************/
typedef struct tagStDTMF_ST
{
    unsigned int    call_ID;
    unsigned char   cDTMFEvent;
}StDTMF_S;
/* <DTS2013083001384 xiazhongyue 20130830 begin */
#ifdef SUPPORT_ATP_NDIS_DIALUP
/*****************************************************************************
** 命令功能: 拨号状态变化指示
** 命令格式: 
