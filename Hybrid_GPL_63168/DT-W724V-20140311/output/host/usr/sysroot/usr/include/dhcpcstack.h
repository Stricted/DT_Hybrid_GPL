...
*********************************************************************************/
#ifndef _DHCPCSTACK_H
#define _DHCPCSTACK_H
...
#ifdef ATP_DEBUG
#define StackDebug(str, args...) do { printf(str, ## args); \
				printf("\n"); } while(0)
#else
#define StackDebug(str, args...)
#endif
...
/******************************************************************************
  ...
  其它说明：
            ...
            ...
******************************************************************************/
int ATP_DHCP_SendPacket(ATP_DHCP_PACKET_ST *pstPacket,ATP_DHCP_FIVE_TEAM_ST *pstFiveTeam,u_int32_t ulType);
...
const char * ATP_DHCPC_GetVersion(void);
