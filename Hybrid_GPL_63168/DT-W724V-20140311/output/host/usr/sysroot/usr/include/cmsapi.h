...
extern VOS_VOID ATP_CMS_SelfClrQueueMsg(VOS_VOID);
...
/*!
  \brief 返回子网掩码1的位数(即压缩形式的掩码)，调用前应该先判断掩码是否合法
  \param[in]  ulMask: 需转换的子网掩码
  \return ulMaskBits: 子网掩码1的位数
*/
VOS_UINT32 ATP_UTIL_ToSubnetMaskBit(VOS_UINT32 ulMask);
/*2.MAC Valid*/
/*!
  \brief 校验MAC 地址
...
*/
VOS_INT ATP_UTIL_GetInterfaceNameById(VOS_INT  lInterId, VOS_CHAR *pcInterName, VOS_UINT32 ulLen);
