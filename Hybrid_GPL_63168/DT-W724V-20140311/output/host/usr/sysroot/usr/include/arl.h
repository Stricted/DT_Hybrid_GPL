...
#define ARL_VER_STR              "v" ARL_VERSION " " __DATE__ " " __TIME__
...
extern uint8_t arlGetHwEngine(uint32_t hwTuple);
extern uint16_t arlGetHwEntIx(uint32_t hwTuple);
