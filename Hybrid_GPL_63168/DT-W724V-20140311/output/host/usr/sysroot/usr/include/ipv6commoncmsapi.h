...
#define IPV6_BR0GUAARRE_CONFIG       ("/var/mac/Br0GuaAddr")
...
//!\brief 用于说明调用WanIpv6NotifyLan的场景，WanIpv6NotifyLan会根据不场景做不同处理
/*!
 *
 */
typedef enum tag_IPV6_NOTIFY_TYPE_E
{
    IPV6_NOTIFY_INIT = 0,//ipv6 init
    IPV6_NOTIFY_WANCHANGE,//ipv6 wan up/down
    IPV6_NOTIFY_PRIVACY_BTN,//DT privacy button, change RA prefix
}IPV6_NOTIFY_TYPE_E;
...
VOS_UINT32 WanIpv6NotifyLan(const  VOS_VOID *pcWanPath, IPV6_NOTIFY_TYPE_E enType);

VOS_BOOL ATP_IsHaapPrefixGot();
