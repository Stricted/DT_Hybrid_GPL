...
VOS_BOOL ATP_DHCPS_DhcpsIsIPManuallyStaticCfged(VOS_UINT32 ulYiaddr, const VOS_UINT8 * pucMac, const ATP_DHCP_SERVER * dhcpSrvInfo);
...
VOS_UINT32 DhcpsSyncManageableDeviceByMacIp(MANUAL_CFG_STATIC_HOST * pManualCfgHost);
