...
#define DNS_ADDR_MASK4_NUM        (32)
#define DNS_ADDR_MASK6_NUM        (128)
...
#define ATP_DNS_QUERY_ONDEMAND_SAVE_TIME (5000)
#endif

#ifdef SUPPORT_ATP_HYBRID
#define ATP_DNS_TIMEOUT_STATE6 ATP_DNS_TIMEOUT_STATE5
#define ATP_DNS_TIMEOUT_STATE7 ATP_DNS_TIMEOUT_STATE5

#endif

/*Start of Protocol 2014-5-24 for UDK0000351459 Filter list TTL修改  by y00250667*/
#define DNS_FWD_FILTER_LIST_CHAIN "FWD_FILTER_LIST"
/*End of Protocol 2014-5-24 for UDK0000351459 Filter list TTL修改  by y00250667*/
...
/*Start of Protocol 2014-5-24 for UDK0000351459 Filter list TTL修改  by y00250667*/
VOS_BOOL ATP_DNS_DomainCheck(const VOS_CHAR* pcName);

/*Start of Protocol 2014-5-26 for UDK0000351459 Filter list TTL问题 by y00250667*/
VOS_VOID ATP_DNS_DomainProc(const ATP_DNS_RECORDS_ST *pstRecord, const ATP_DNS_PACKET_ST *pstPacket);
/*End of Protocol 2014-5-26 for UDK0000351459 Filter list TTL问题 by y00250667*/

VOS_VOID ATP_DNS_DomainInit();

VOS_VOID ATP_DNS_DomainAdd(const ATP_DNS_DOMAIN_ITEM_ST* pstItem);

VOS_VOID ATP_DNS_DomainDel(const ATP_DNS_DOMAIN_ITEM_ST* pstItem);
/*End of Protocol 2014-5-24 for UDK0000351459 Filter list TTL修改  by y00250667*/
...
ATP_DNS_PACKET_ST *ATP_DNS_PacketBuildHostResponse(const ATP_DNS_PACKET_ST *pstQuery,
                                                    const ATP_DNS_RECORDS_ST  astRecord[], VOS_UINT16 usRecordNum,VOS_UINT32 ulGenTime);
...
typedef enum
{
    DNS_SERVER_SAME,
    DNS_SERVER_SIMILAR,
    DNS_SERVER_DIFFERENT
}DNS_TWO_SERVER_TYPE_EN;
...
typedef struct tagATP_DNS_WAN_INFO_ST
{
    ...
    VOS_BOOL        bManuel;
    VOS_BOOL        bWebType;
	/*Start of ATP 2014-5-8 for DTS2014042408517 by y00250667*/
    VOS_UINT32      ulFlag;
	/*End of ATP 2014-5-8 for DTS2014042408517 by y00250667*/
} ATP_DNS_WAN_INFO_ST;

/*Start of ATP 2014-5-8 for DTS2014042408517 by y00250667*/ 
#define ATP_DNS_WAN_DLLETE_FLAG (0x10000000)
/*End of ATP 2014-5-8 for DTS2014042408517 by y00250667*/

/*Start of Protocol 2014-5-24 for UDK0000351459 Filter list TTL修改  by y00250667*/
#ifdef ATP_DEBUG
#define DnsExec(x) {ATP_DNS_DEBUG(x); ATP_Exec(x);}
#else
#define DnsExec(x) {ATP_Exec(x);}
#endif
/*End of Protocol 2014-5-24 for UDK0000351459 Filter list TTL修改  by y00250667*/

VOS_UINT32 ATP_DNS_WanInfoAppend(ATP_DNS_SERVER_ST *pstServer,  const VOS_CHAR *pcDnsAddress, const VOS_BOOL bManuel, const VOS_CHAR *pcWanIP,
...
struct addrinfo *ATP_DNS_WanInfoFindNthServerAddress(const ATP_DNS_WAN_INFO_ST *pstWanInfo, VOS_UINT32 ulIdx, VOS_BOOL isFonQry);
...
VOS_VOID ATP_DNS_WanInfoSort(ATP_DNS_SERVER_ST *pstServer);

VOS_VOID ATP_DNS_UpdateDNSServer(VOS_CHAR *pstDnsServers, VOS_CHAR *acInterface, ATP_DNS_STATIC_WAN_INFO_LIST_ST *pstStaticWanList, VOS_CHAR *pstDnsStaticServers);
...
#define ATP_DNS_QUERY_FLAG_FON_D     (0x0002)//标记FON客户端自己发的DNS
#define ATP_DNS_QUERY_FLAG_ONDEMAND_D     (0x0004)
...
/*Start of ATP 2014-5-8 for DTS2014042408517 by y00250667*/
#define ERROR_ADDR_UNAVAILABLE             (126)
/*End of ATP 2014-5-8 for DTS2014042408517 by y00250667*/
...
typedef struct tagATP_DNS_CACHE_ST
{
    ...
    ATP_DNS_PACKET_ST   *pstPacket;
    VOS_UINT32          ulFlags;               //预留32位flag
} ATP_DNS_CACHE_ST;

#define ATP_DNS_CACHE_FLAG_FON (1)

#ifdef SUPPORT_ATP_DNS_SERVERPRIORITY_W724V
/* BEGIN: add for HOMEGW-15730 Data: Insufficient cache for DNS requests by l00214441 2013.09.09 */  
#define ATP_DNS_MAX_CACHE_NUM_D             (2048)
/* END: add for HOMEGW-15730 Data: Insufficient cache for DNS requests by l00214441 2013.09.09 */  
#else
#define ATP_DNS_MAX_CACHE_NUM_D             (30)
#endif
#define ATP_DNS_MAX_CACHE_SIZE_D             (512*1024)
...
VOS_UINT32 ATP_DNS_CacheAppend(ATP_DNS_SERVER_ST *pstServer, const ATP_DNS_PACKET_ST *pstPacket, VOS_BOOL bIsFonDns);


ATP_DNS_CACHE_ST *ATP_DNS_CacheFind(ATP_DNS_CACHE_ST *pstCacheList, const ATP_DNS_QUESTION_ST *pstQuestion, VOS_BOOL bIsFonDns);
...
VOS_VOID ATP_DNS_Print_Cache_Info(FILE *fp, const ATP_DNS_SERVER_ST *pstServer);
VOS_UINT32 ATP_DNS_CacheGetMemorySize(ATP_DNS_CACHE_ST *pstCacheList);
...
struct tagATP_DNS_SERVER_ST
{
    ...
    ATP_DNS_STATIC_WAN_INFO_LIST_ST   *pstStaticWanList;
 ...
 *  DNS adapt functions
 */
VOS_UINT32 ATP_DNS_AdaptDoRelay(const ATP_DNS_SOCKET_ST *pstServerSocket, ATP_DNS_QUERY_ST *pstQuery, const VOS_CHAR* pcIntf);
...
ATP_DNS_CACHE_ST *ATP_DNS_AdaptFindCahe(const ATP_DNS_SERVER_ST *pstServer, const struct addrinfo *pstFromAddr,
                                        const ATP_DNS_QUESTION_ST *pstQuestion, VOS_BOOL bIsFon);
VOS_UINT16 ATP_DNS_AdaptGetRandomNum(const VOS_UINT16 ulDev);
#ifdef SUPPORT_ATP_FON
#define DNS_FON_BIND_IF "br0"

#define DNS_INTERFACE_PPP   "ppp256"
#define DNS_INTERFACE_LTE    "rmnet0"
#define DNS_INTERFACE_VLAN8_NUM    "8"
#define DNS_INTERFACE_PATH_PPP   "Device.IP.Interface.2"
#define DNS_INTERFACE_PATH_LTE    "Device.IP.Interface.6"
#define DNS_INTERFACE_PATH_VLAN8    "Device.IP.Interface.3"

#define DNS_SERVER_PRIMARY   "primary"


VOS_UINT16 ATP_DNS_AdaptGetFONRandomNum();
#endif
...
VOS_BOOL DnsWanIsDhcp(const ATP_DNS_WAN_INFO_ST *pstWan);
VOS_VOID ATP_DNS_AdaptRelayAllOndemandQuery();
VOS_VOID DnsDtResetP008LogTimer(VOS_VOID);
VOS_BOOL IsWanIPCP(const ATP_DNS_WAN_INFO_ST *pstWan);
VOS_VOID ATP_DNS_SetDynServer(const VOS_CHAR* pcServers, VOS_UINT32 ulLen);
VOS_VOID ATP_DNS_DelDynServer(const ATP_DNS_WAN_INFO_ST *pstWan);
VOS_BOOL DnsInitFonBindAddr();
#ifdef SUPPORT_ATP_HYBRID
VOS_BOOL DnsWanIsLte(const ATP_DNS_WAN_INFO_ST *pstWan);
#endif
#endif
#define IS_FON_QUERY(x) (ATP_DNS_QUERY_FLAG_FON_D == (((x)->usFlags) & ATP_DNS_QUERY_FLAG_FON_D))


VOS_VOID ATP_DNS_AdaptGetInfo();
VOS_VOID ATP_DNS_AdaptGetMemoryInfo();
VOS_VOID ATP_DNS_AdaptSaveStaticDNSInfo(ATP_DNS_STATIC_WAN_INFO_LIST_ST **ppstStaticWanList, ATP_DNS_STATIC_WAN_INFO_ST *pstStaticWanMsg);
VOS_VOID ATP_DNS_AdaptDelStaticDNSInfo(ATP_DNS_STATIC_WAN_INFO_LIST_ST **ppstStaticWanList, ATP_DNS_STATIC_WAN_INFO_ST *pstStaticWanMsg);
