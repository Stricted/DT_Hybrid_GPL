/*
 * "$Id: array.c 8532 2009-04-20 21:37:14Z mike $"
 *
              ...
              void         *e)		/* I - Element */
{
  ...
  */
  ...
  if (!a )    
    {
     // printf("\n==file:%s,line:%d,func:%s=Printers is NULL=\n",__FILE__,__LINE__,__FUNCTION__);
    return (NULL);
    }

  if (!e )    
    {
     // printf("\n==file:%s,line:%d,func:%s=e is NULL=\n",__FILE__,__LINE__,__FUNCTION__);
    return (NULL);
    }
  ...
  */
  ...
  if (!a->num_elements)
    {
  //  printf("==file:%s,line:%d,func:%s=cupsArrayCount=%d=\n",__FILE__,__LINE__,__FUNCTION__,cupsArrayCount(a));
  //   printf("\n==file:%s,line:%d,func:%s=9999=the array is empty=\n",__FILE__,__LINE__,__FUNCTION__);
    return (NULL);
    }
  //printf("\n==file:%s,line:%d,func:%s==\n",__FILE__,__LINE__,__FUNCTION__);
 /*
...
/*
 * End of "$Id: array.c 8532 2009-04-20 21:37:14Z mike $".
 */
