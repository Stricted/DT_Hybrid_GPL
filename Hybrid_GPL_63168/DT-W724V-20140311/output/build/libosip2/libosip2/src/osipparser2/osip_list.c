...
{  
  /* BEGIN: add for DTS2013052506350 下挂PC使用软件3CX注册SIP服务器，多次注册会导致网关的SIP ALG进程消失 by l00214441 2013.07.19 */ 
  if (NULL == li)
  {
        return -1;
  }
  ...
  /* END: add for DTS2013052506350 下挂PC使用软件3CX注册SIP服务器，多次注册会导致网关的SIP ALG进程消失 by l00214441 2013.07.19 */   
  return 0;			/* ok */
}
