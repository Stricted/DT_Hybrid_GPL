/*
 *   $Id: radvdump.c,v 1.1 2009/08/22 07:51:03 y42304 Exp $
 *
 *   Authors:
...
print_ff(unsigned char *msg, int len, struct sockaddr_in6 *addr, int hoplimit, unsigned int if_index, int edefs)
{
	...
	while (len > 0)
	{
		...
		case ND_OPT_HOME_AGENT_INFO:
			ha_info = (struct HomeAgentInfo *)(int)opt_str;
	...
	while (orig_len > 0)
	{
		...
		case ND_OPT_PREFIX_INFORMATION:
			...
			break;
		case ND_OPT_ROUTE_INFORMATION:
			rinfo = (struct nd_opt_route_info_local *) (int)opt_str;
			...
			break;
		case ND_OPT_RDNSS_INFORMATION:
			rdnss_info = (struct nd_opt_rdnss_info_local *) (int)opt_str;
