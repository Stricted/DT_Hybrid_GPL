/*
 *   $Id: interface.c,v 1.1 2009/08/22 07:51:00 y42304 Exp $
 *
 *   Authors:
...
check_iface(struct Interface *iface)
{
	...
	/* BEGIN: Modified by h00169677, 2012/7/2   PN:DTS2012062803593  */
    /*
   ...
   */
    if (iface->if_maxmtu != -1 && (iface->AdvLinkMTU > iface->if_maxmtu))
    {
        iface->AdvLinkMTU = iface->if_maxmtu;
    }
	/* END:   Modified by h00169677, 2012/7/2 */
