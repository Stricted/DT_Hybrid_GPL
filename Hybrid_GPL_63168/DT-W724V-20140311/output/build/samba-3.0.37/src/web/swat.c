...
/* Modified by y00183935@2013.01.07 for CVE-2011-2522 */
		    ...
		    const char *formname, time_t xsrf_time, char token_str[33])
{
	...
	uint8_t token[16];
	int i;
    /* Modified by y00183935@2013.11.20 for CVE-2013-0214 */
...
/* Modified by y00183935@2013.11.20 for CVE-2013-0213 */
#if 0
...
static void chg_passwd(void)
{
	...
	if(cgi_variable(CHG_S_PASSWD_FLAG)) {
		printf("<p>");
		if (rslt == True) {
/* Modified by y00183935@2013.01.07 for CVE-2011-2694 */
#if 0
