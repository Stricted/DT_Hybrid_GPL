...
/* USER Activites: */
	...
	if( DEBUGLVL( IS_IPC(conn) ? 3 : 1 ) ) {
        ...
        /*delete for DTS2011102703388 by liuyingbiao 00193021@20111105*/ 
        process_smbd_user_pid(SMBD_USER_PID_DEL, NULL, getpid());
        /*delete for DTS2011102703388 by liuyingbiao 00193021@20111105*/   
      
        /*Start of modified by lvxin 00135113@20090525 for AU4D01765 samba user delete*/
        process_smbd_user_pid(SMBD_USER_PID_ADD, conn->user ,getpid());
