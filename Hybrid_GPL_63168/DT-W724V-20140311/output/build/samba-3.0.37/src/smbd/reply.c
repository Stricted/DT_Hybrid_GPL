...
#ifdef SUPPORT_LOGIN_CONTROL //added by qichenghong 2009.12.03
	if(g_ucLoginCtlFlag && ('\0' != vuser->user.smb_name[0]))
	{
		ATP_LoginCtlLogout(vuser->user.smb_name , client_addr() ,ATP_LOGINTYPE_SAMBA);
            /*add by y00181549 fot W724v log at 20120718*/
            ATP_LOG_LogItemPrint(ATP_SYS_LOG_UMOUNT_USER_LOGOUT_INFO,vuser->user.smb_name,client_addr());
	}
#endif
