...
#include <limits.h>
#include "mount.h"
/* Modified by y00183935@2013.01.08 for CVE-2011-1678 */
#include <signal.h>
/* Modified by y00183935@2013.01.08 for CVE-2011-1678 */
...
/* Modified by y00183935@2013.01.08 for CVE-2010-0547 */
/*
...
static int check_mtab(const char *progname, const char *devname,
			const char *dir)
{
/* Modified by y00183935@2013.01.08 for CVE-2011-2724 */
#if 0
...
/*	case 'a':	       
	...
	if(got_user == 0) {
		...
		if (user_name == NULL)
			user_name = getusername(getuid());      /* Modified by y00183935@2013.01.08 for CVE-2011-1678 */
		got_user = 1;
	}
