 ...
 */
static unsigned get_cpu_count(void)
{
	FILE *fp;
	char line[256];
	int proc_nr = -1;
...
static void main_loop(void)
{
    ...
    // TODO: 需要从2.6.31移植 /proc/softirqs 文件统计和创建方式,到时候可以删除本代码
...
int mpstat_main(int argc, char **argv)
{
    ...
    // TODO: 需要从2.6.31移植 /proc/softirqs 文件统计和创建方式
