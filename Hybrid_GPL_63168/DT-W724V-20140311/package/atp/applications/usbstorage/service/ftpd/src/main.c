...
#endif
//RESOURCE_LEAK	/home/atp/v1r5c2_0216/trunk/package/atp/applications/usbstorage/service/ftpd/src/main.c
...
/*Added by yehuisheng00183935@20110702 添加ftpds功能*/
        ...
        if (-1 == listensocket)  //判断是否通过MIC动态启动   
        {
            ...
            {
#ifdef SO_REUSEADDR
                retval = setsockopt(listensocket, SOL_SOCKET, SO_REUSEADDR, (void *) &i,
                sizeof(i));
#endif
#ifdef SO_REUSEPORT
                retval = setsockopt(listensocket, SOL_SOCKET, SO_REUSEPORT, (void *) &i,
                sizeof(i));
#endif
				if (0 != retval)
				{
...
/*Added by yehuisheng00183935@20110702 添加ftpds功能*/
        ...
        if (-1 == listensocket_implicit)  //判断是否通过MIC动态启动   
        {
            ...
            {
#ifdef SO_REUSEADDR
                retval = setsockopt(listensocket_implicit, SOL_SOCKET, SO_REUSEADDR, (void *) &i,
                sizeof(i));
#endif
#ifdef SO_REUSEPORT
                retval = setsockopt(listensocket_implicit, SOL_SOCKET, SO_REUSEPORT, (void *) &i,
                sizeof(i));
#endif
				if (0 != retval)
				{
