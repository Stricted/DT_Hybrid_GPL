...
#define MAXSTRLEN 256   /*for ppp username length 255*/
...
#ifndef ATP_FON_FILE_STAT_TOTAL
#define ATP_FON_FILE_STAT_TOTAL           "/var/fon/stat_total"
#define ATP_FON_FILE_STAT_SESSION       "/var/fon/stat_session"
#endif

#ifndef WLAN_FON_ASSOCDEV_FILE
...
#define SERVER_VERSION "xl2tpd-1.1.11"
...
#define DEFAULT_HELLO_RETRANSMISSION_DELAY 20
...
#ifdef USE_KERNEL
    int kernel_fd;  /*fd for use pppol2tp socket with kernel*/
#endif
    struct call *self;
...
#define CHILLOUT_MSG_SEND      0
#define CHILLOUT_MSG_NOTSEND   1
...
extern int init_server_socket(void); /* LNS错误导致无法建立隧道 DTS2012103105714 */
