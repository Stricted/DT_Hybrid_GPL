...
struct gengetopt_args_info
{
  ...
  int radiusretryiteration_arg;	/**< @brief Total number of retries iteration (default='1').  */
  char * radiusretryiteration_orig;	/**< @brief Total number of retries iteration original value given at command line.  */
  const char *radiusretryiteration_help; /**< @brief Total number of retries iteration help description.  */  
  ...
  unsigned int radiusretryiteration_given ;	/**< @brief Whether radiusretryiteration was given.  */  
