...
#define STRLEN_AUTH 256         /* Maximum length of usernam and password */
...
struct lac
{
    ...
    char authname[STRLEN_AUTH];      /* Who we authenticate as */
    char password[STRLEN_AUTH];      /* Password to authenticate with */
...
struct global
{
    ...
    int hello_retransmission_delay;
};
