...
struct session {
	...
	char name_bak[IFNAMSIZ];		/*dev_bak name */
	#endif
...
extern void poe_error __P((struct session *, char *, ...));	
extern void poe_dbglog __P((struct session *, char *, ...));
extern void poe_info __P((struct session *, char *, ...));
extern void poe_fatal __P((struct session *, char *, ...));
extern void poe_die __P((int));
