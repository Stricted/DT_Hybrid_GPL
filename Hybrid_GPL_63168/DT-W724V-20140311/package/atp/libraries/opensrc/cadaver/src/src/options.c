...
#define S(x,h) S2(#x, opt_##x, h)
    ...
    { "workmode", opt_workmode, NULL, opt_string, NULL, NULL, NULL,
      "cadaver work mode", NULL },
    { "mediencenter", opt_mediencenter, NULL, opt_string, NULL, NULL, NULL,
      "Mediencenter server uri", NULL },
    { "media_username", opt_medusername, NULL, opt_string, NULL, NULL, NULL,
      "Mediencenter Account User Name", NULL},
    { "media_password", opt_medpassword, NULL, opt_string, NULL, NULL, NULL,
      "Mediencenter Account Password", NULL},
    { "proxy_username", opt_proxyusername, NULL, opt_string, NULL, NULL, NULL,
      "Proxy Account User Name", NULL},
    { "proxy_password", opt_proxypassword, NULL, opt_string, NULL, NULL, NULL,
      "Proxy Account Password", NULL},
    { "processname", opt_processname, NULL, opt_string, NULL, NULL, NULL,
      "The process name whichi register on Mic", NULL},
    { "fprocessname", opt_fprocessname, NULL, opt_string, NULL, NULL, NULL,
      "The father process name whichi register on Mic", NULL},
#undef S
