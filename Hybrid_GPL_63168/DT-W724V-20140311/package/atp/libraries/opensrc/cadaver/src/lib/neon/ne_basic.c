...
/* Begin: add by l00203771 fetch the detail response code */
unsigned int neon_http_status_code;
/* End: add by l00203771 fetch the detail response code */
...
/* Begin: add by l00203771 fetch the detail response code */
    neon_http_status_code = ne_get_status(req)->code;
    printf("\r\n FILE:%s LINE:%d status->code = %d\n", __FILE__, __LINE__, ne_get_status(req)->code);
/* End: add by l00203771 fetch the detail response code */
